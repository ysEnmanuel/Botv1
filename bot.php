...
$botToken = "5112200227:AAH0X28n5xjT-pZI5e-z6At848_kb8ZPiyQ";
...
function checkId($userId){
    $mainids = array("1054154613"); #PUT HERE Premium USERID
    if($userId == "1054154613"){#Add Here Your Id if ur owner
        $show = "Owner";
        }
